...
??? eccv-phase3 "Phase 3 - Multi-view JEPA pretraining (left and right eyes as paired views)"
    ...
    **Training objectives:**  
    ...
    <div data-progress>
    <ul>
      <li class="done">Decide on which model/ backbone to use</li>
      <li class="done">Obtain pretraining dataset</li>
      <li class="done">Define left–right eye view construction from front-facing images</li>
      <li class="done">Implement JEPA predictive objective with embedding-to-embedding targets</li>
      <li class="done">Train JEPA encoder on CFC dataset</li>
      <li class="done">Freeze trained JEPA encoder for downstream analysis</li>
      <li class="done">Geometry experiments on emebdding with ID and OOD data</li>
      <li>Landmark probe experiments</li>
    </ul>
    </div>
