...
??? dataset-pretraining "Foundational Model Pretraining Dataset"
    ...
    **Personnel:** Michelle, Georgie  
    ...
    <ul>
        ...
        <li class="done">Repeat sampling and subsampling steps for Batch 2</li>
        ...
        <li>Predict periorbital distances on Subset 3</li>
        <li>Determine what if any validation we need on periorbital distances</li>
        <li>Some type of masked autoencoder (?) training (meet with sathya) to show that we can learn good representations</li>
